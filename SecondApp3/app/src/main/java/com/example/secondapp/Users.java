...
public class Users {
    ...
    * будет сопоставить колонки*/
    ...
    // Метод который записывает новое значение юзера при редактировании на активность UserFormActivity
    public User getUserFromDB(UUID uuid){
        ...
        // Прочитали первую строчку, которая пришла в ответ
        cursorWrapper.moveToFirst();

        // Сохранили эту строчку в пользователя
